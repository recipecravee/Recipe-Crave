  ...
  return (
    <header className="sticky top-0 z-40 border-b border-ink/10 bg-cream-100/80 backdrop-blur-md">
      <div className="container flex h-16 items-center justify-between gap-6">
        ...
        <form action="/recipes" method="get" className="hidden sm:flex w-full max-w-xs items-center gap-2 rounded-full border border-ink/10 bg-white px-3 py-1.5 shadow-sm focus-within:border-terracotta-400">
