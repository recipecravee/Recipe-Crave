...
const PANEL_RECIPES: MegaPanel = {
  ...
  columns: [
    ...
    {
      heading: 'By menu section',
      items: [
        { href: '/categories/breakfast', label: 'Breakfast', icon: Coffee },
        { href: '/categories/snacks', label: 'Snacks', icon: Sparkles },
        { href: '/categories/small-chops', label: 'Small Chops', icon: Sparkles },
        { href: '/categories/pasta', label: 'Pasta', icon: Wheat },
        { href: '/categories/rice', label: 'Rice', icon: Wheat },
        { href: '/categories/soups', label: 'Soups', icon: Soup },
        { href: '/categories/stews-sauces', label: 'Stews & Sauces', icon: CookingPot },
        { href: '/categories/desserts', label: 'Desserts', icon: Cake },
      ],
    },
    {
      heading: 'More categories',
      items: [
        { href: '/categories/grills', label: 'Grills', icon: Beef },
        { href: '/categories/sides', label: 'Sides', icon: Salad },
        { href: '/categories/porridges', label: 'Porridges', icon: CookingPot },
        { href: '/categories/drinks', label: 'Drinks', icon: Coffee },
        { href: '/categories/iced-treats', label: 'Iced Treats', icon: Cake },
        { href: '/categories/cocktails-mocktails', label: 'Cocktails & Mocktails', icon: Wine },
        { href: '/categories', label: 'All 14 categories →' },
      ],
    },
  ],
  bottomCta: [
